...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Matlab
    \end{itemize}
  \item Version control in some way, preferably with git if you end up doing
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item General principles like modularity, writing code to be read,
    documenting what you do, \ldots
  \end{itemize}
\end{frame}
