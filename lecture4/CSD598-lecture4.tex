...
\frame{\frametitle{Choosing a good graph}
  \begin{itemize}
    ...
    \item Secondarily it can be to aid with conveying of information by, for
    example, making the graph look nice and actually be read as a result.
  \end{itemize}
}
...
\frame{\frametitle{Resources for choosing a graph}
  \begin{itemize}
    \item \url{https://royal-statistical-society.github.io/datavisguide/} good,
    approachable guide to data visualisation.
    \item \url{https://www.data-to-viz.com/} actual recommendations with actual
    code (R, Python, D3.js, React) to get going. 
    \item \url{https://r-graph-gallery.com/ggplot2-package.html} neat gallery
    for getting to know different graph types.
